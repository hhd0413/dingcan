...
python manager.py runjob -m stat/daily -a member -p 2020-04-19
python manager.py runjob -m stat/daily -a food -p 2020-04-19
python manager.py runjob -m stat/daily -a site -p 2020-04-20
'''
class JobTask():
    def __init__(self):
        pass
